...
if (!employeeId) {
  ...
  return;
    ...
    const fetchLeaveRequests = async () => {
      try {
        const response = await axios.get(`https://ssit-leaves-backend.azurewebsites.net/api/leave/employee/${employeeId}`);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://ssit-leaves-backend.azurewebsites.net/api/leave/delete/${id}`);
